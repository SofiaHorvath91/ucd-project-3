...
class House(models.Model):
    ...
    symbol = models.CharField(max_length=1000, blank=True, null=True)
    element = models.CharField(max_length=1000, blank=True, null=True)
    traits = models.CharField(max_length=5000, blank=True, null=True)
    founder = models.CharField(max_length=5000, blank=True, null=True)
    commonroom = models.CharField(max_length=5000, blank=True, null=True)
    ghost = models.CharField(max_length=1000, blank=True, null=True)
