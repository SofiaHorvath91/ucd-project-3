...
class House(models.Model):
    ...
    symbol = models.CharField(max_length=600, blank=True, null=True)
    element = models.CharField(max_length=600, blank=True, null=True)
    traits = models.CharField(max_length=600, blank=True, null=True)
    founder = models.CharField(max_length=600, blank=True, null=True)
    commonroom = models.CharField(max_length=600, blank=True, null=True)
    ghost = models.CharField(max_length=600, blank=True, null=True)
